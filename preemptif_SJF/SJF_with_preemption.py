def sjf_with_preemption(processes):
    ...
    while completed != n:
        ...
        for i in range(n):
            if remaining_time[i] > 0 and processes[i]['Arrival_Time'] <= current_time:
        ...
        if remaining_time[shortest] == 0:
            ...
            waiting_times[shortest] = end_time - processes[shortest]['Burst_Time'] - processes[shortest]['Arrival_Time']
